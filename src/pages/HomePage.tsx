        ...
        <div className="container mx-auto px-4">
          ...
          {featuredReleases.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-grimdark-300 mb-4">No featured releases available yet.</p>
      ...
      <section className="py-20 bg-blackmetal-900">
        <div className="container mx-auto px-4">
          ...
          {featuredProducts.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-grimdark-300 mb-4">No featured products available yet.</p>
              <Link to="/shop" className="btn-outline">
                Visit Shop
              </Link>
            </div>
              ...
              {featuredProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="mt-2 text-lg font-bold text-blood-red">R${product.price.toFixed(2)}</p>
                  </div>
                </motion.div>
              ))}
            </div>
